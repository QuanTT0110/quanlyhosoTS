...
const r200 = (res: Response, data: any, message: string = "Success") => {
  return res.status(200).json({ message, data: data });
};

const r404 = (res: Response, message: string = "Data not found") => {
  return res.status(404).json({ message });
};

const r403 = (res: Response, message: string = "Data input not valid") => {
